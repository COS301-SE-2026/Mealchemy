...
SELECT user_id, 'Eggs',                          'dairy'::pantry_category_enum,                4,               NULL::text,       FALSE, NULL::integer  FROM admin_user UNION ALL
...
SELECT user_id, 'Parmesan cheese',               'dairy'::pantry_category_enum,                NULL::numeric,   NULL::text,       FALSE, NULL::integer  FROM admin_user UNION ALL
SELECT user_id, 'Broccoli',                      'produce'::pantry_category_enum,              2,               'heads',    FALSE, NULL::integer  FROM admin_user UNION ALL
SELECT user_id, 'Scallions',                     'produce'::pantry_category_enum,              4,               NULL::text,       FALSE, NULL::integer  FROM admin_user UNION ALL
...
SELECT user_id, 'Yellow onion',                  'produce'::pantry_category_enum,              1,               NULL::text,       FALSE, NULL::integer  FROM admin_user UNION ALL
...
SELECT user_id, 'Fresh parsley',                 'produce'::pantry_category_enum,              NULL::numeric,   NULL::text,   FALSE, NULL::integer  FROM admin_user UNION ALL
...
SELECT user_id, 'Black pepper',                  'spices'::pantry_category_enum,               NULL::numeric, NULL::text,       FALSE, NULL::integer  FROM admin_user UNION ALL
