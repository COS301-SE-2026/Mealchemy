...
class ApiVaultRepository implements VaultRepository {
  ...
  @override
  Future<Vault> updateVault(int id, int ownerId, String vaultType, String name) async {
  ...
  Future<List<VaultFolder>> getFoldersByVaultId(int vaultId) async {
    ...
    return (response.data as List).map((json) => VaultFolder.fromJson(json)).toList();
  }
  ...
  @override
  Future<VaultFolder> updateFolder(int id, int vaultId, String folderName) async {
  ...
  Future<List<VaultFolderRecipe>> getRecipesByFolderId(int folderId) async {
    ...
    return (response.data as List).map((json) => VaultFolderRecipe.fromJson(json)).toList();
  }
  ...
  @override
  Future<VaultFolderRecipe> createFolderRecipe(int folderId, int recipeId) async {
  ...
  @override
  Future<VaultFolderRecipe> updateFolderRecipe(int id, int folderId, int recipeId) async {
