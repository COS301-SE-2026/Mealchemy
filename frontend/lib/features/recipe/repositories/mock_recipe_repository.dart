...
class MockRecipeRepository implements RecipeRepository {
  static final List<Recipe> _recipes = [
    Recipe(
      ...
      description: 'A rich and creamy Italian classic finished with saffron threads and parmesan.',
      cuisineType: 'italian',
      prepTimeMins: 15,
      cookingTimeMins: 30,
      servingSize: 4,
      ...
      steps: const [
        RecipeStep(stepId: 201, recipeId: 1, stepNr: 1, content: 'Warm the stock in a separate pot and steep the saffron threads in it until the colour bleeds out.'),
        RecipeStep(stepId: 202, recipeId: 1, stepNr: 2, content: 'Toast the arborio rice with garlic in olive oil for two minutes, then add stock one ladle at a time, stirring until absorbed.'),
        RecipeStep(stepId: 203, recipeId: 1, stepNr: 3, content: 'Once the rice is al dente, fold in the grated parmesan and rest for two minutes before serving.'),
      ],
    ),
    ...
    Recipe(
      ...
      description: 'A fresh and vibrant cold pasta salad with cherry tomatoes, mini mozzarella, and basil.',
      cuisineType: 'italian',
      prepTimeMins: 15,
      cookingTimeMins: 15,
      servingSize: 6,
      ...
      steps: const [
        RecipeStep(stepId: 204, recipeId: 2, stepNr: 1, content: 'Cook the cavatappi pasta until just past al dente, drain, and toss with olive oil to cool.'),
        RecipeStep(stepId: 205, recipeId: 2, stepNr: 2, content: 'Whisk olive oil, lemon juice, balsamic vinegar, garlic, salt and pepper into a dressing.'),
        RecipeStep(stepId: 206, recipeId: 2, stepNr: 3, content: 'Combine the cooled pasta with the tomatoes, mozzarella and basil, dress, and toss to coat.'),
      ],
    ),
  ];
