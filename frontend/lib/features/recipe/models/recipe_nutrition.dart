//nutrition values already calculated by backend
...
//nutrition contribution made by 1 recipe ingredient
class IngredientNutrition {
  ...
  factory IngredientNutrition.fromJson(Map<String, dynamic> json) {
    return IngredientNutrition(
      ...
      values: NutritionValues.fromJson(json),
      percentOfRecipeCalories: _readDouble(json['percent_of_recipe_calories']),
    );
  }
}

//complete response used by Nutrition tab for 1 recipe
class RecipeNutrition {
  ...
  factory RecipeNutrition.fromJson(Map<String, dynamic> json) {
    ...
    return RecipeNutrition(
      ...
      totals: NutritionValues.fromJson(
        json['totals'] as Map<String, dynamic>? ?? const {},
      ),
      perServing: NutritionValues.fromJson(
