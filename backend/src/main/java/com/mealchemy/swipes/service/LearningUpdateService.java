...
public class LearningUpdateService {
    ...
    public LearningUpdateService(UserPreferenceWeightsRepository userPreferenceWeightsRepository, UserCuisineAffinitiesRepository userCuisineAffinitiesRepository, EngineClient engineClient)
    {
