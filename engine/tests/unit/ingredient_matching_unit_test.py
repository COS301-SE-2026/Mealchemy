...
from src.core.ingredient_matching import (
    allergen_check,
    get_missing_ingredients,
    pantry_ingredient_match,
)
...
class TestAllergenCheck:
    ...
    def test_multiple_allergens_any_matcch_blocks(self, ingredient_factory):
        recipe_ingredients = [
            ingredient_factory(1, category_id=4),
            ingredient_factory(2, category_id=11),
        ]
...
class TestGetMissingIngredients:
    def test_returns_names_of_missing_ingredients_only(
        self, ingredient_factory, pantry_entry_factory
    ):
        recipe_ingredients = [
            ingredient_factory(1, name="Owned Thing"),
            ingredient_factory(2, name="Missing Thing"),
        ]
        pantry = [pantry_entry_factory(1)]
